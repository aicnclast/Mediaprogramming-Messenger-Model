...
(function () {
	...
	de_sb_util.AJAX = new function () {
		 ...
		 * @param credentials an object that provides alias and password fields
		...
		Object.defineProperty(this, "invoke", {
			configurable: false,
			enumerable: false,
			value: function (resource, method, header, body, credentials, callback) {
